...
const cases = [
  ...
  {
    slug: "federfarma",
    client: "Federfarma Lombarda",
    tag: "Pharmaceutical · Sovereign AI · Nexus MDS Core",
    headline: "AI RAG platform for 1,000+ pharmacies — entirely on Nexus MDS Core",
    summary:
      "RAG pipeline on 10,000+ pharmaceutical documents with Weaviate, local inference, replaceable external generation, Budibase PWA, and Keycloak Zero-Trust auth. Self-hosted on a single server, no hyperscaler lock-in.",
    metrics: [
      { value: "1,000+", label: "Pharmacies served" },
      { value: "10,000+", label: "Docs vectorised" },
      { value: "Sovereign", label: "No hyperscaler lock-in" },
    ],
  },
  {
    slug: "sorgenia",
