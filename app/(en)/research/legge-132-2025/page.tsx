...
const article = RESEARCH_ARTICLES["legge-132-2025"];
const ARTICLE_URL = "https://www.dynamicsconsulting.it/research/legge-132-2025";
        ...
        <section className="py-24 px-6 bg-gradient-to-b from-[#0D1117] to-[#161B22]">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <time dateTime="2025-10" className="text-xs text-[#7D8FA3]">
                {article.dateLabel}
              </time>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-3 mt-4 text-[#7D8FA3]">
                <li>
                  ...
                  attraversa confini giurisdizionali. Nessun lock-in da hyperscaler.
                </li>
                <li>
