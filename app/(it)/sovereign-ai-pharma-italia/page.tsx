          ...
          <div className="max-w-3xl mx-auto space-y-12 text-[#7D8FA3] text-lg leading-relaxed">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-[#7D8FA3]">
                <li>
                  <strong className="text-[#E6EDF3]">Elaborazione locale, generazione
                  esterna sostituibile</strong>{" "}
                  con modelli open-weight (Llama 3, Mistral, Qwen) eseguiti
                  localmente
                </li>
                <li>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#E6EDF3] mb-4">
                Caso di studio: Federfarma Lombarda
              </h2>
              <p>
                ...
                settore farmaceutico italiano. Federfarma Lombarda — che
                rappresenta oltre 1.000 farmacie nelle province di Milano, Lodi e Monza Brianza —
